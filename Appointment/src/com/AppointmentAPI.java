...
public class AppointmentAPI extends HttpServlet {
	 ...
	 * 
	 * 
	 * Map paras = getParasMap(request); String output =
	 * a.updateItem(paras.get("hidItemIDSave").toString(),
	 * paras.get("p_id").toString(), paras.get("p_name").toString(),
	 * paras.get("p_age").toString(), paras.get("type_of_case").toString(),
	 * paras.get("d_name").toString()); response.getWriter().write(output);
	 * 
	 * 
	 * 
	 * 
